...
public class AutoLeft extends SequentialCommandGroup {
    ...
    private static final Trajectory LEFT_1 =
            PathPlanner.loadPath(
                    "left-1",
                    Constants.kMaxSpeedMetersPerSecond,
                    Constants.kMaxAccelerationMetersPerSecondSquared);
    private static final Trajectory LEFT_2 =
            PathPlanner.loadPath(
                    "left-2",
                    Constants.kMaxSpeedMetersPerSecond,
                    Constants.kMaxAccelerationMetersPerSecondSquared,
                    true);
    private static final Trajectory LEFT_3 =
            PathPlanner.loadPath(
                    "left-3",
                    Constants.kMaxSpeedMetersPerSecond,
                    Constants.kMaxAccelerationMetersPerSecondSquared);
    private static final Trajectory LEFT_4 =
            PathPlanner.loadPath(
                    "left-4",
                    Constants.kMaxSpeedMetersPerSecond,
                    Constants.kMaxAccelerationMetersPerSecondSquared);
    ...
    public AutoLeft() {
        ...
        addCommands(
                ...
                new ParallelDeadlineGroup(
                        new DrivetrainRamseteCommand(RobotContainer.m_drive, LEFT_3),
                        new SpinIntake()),
                new ParallelDeadlineGroup(new WaitCommand(1), new ShootCargo("High")),
                new ParallelDeadlineGroup(
                        new DrivetrainRamseteCommand(RobotContainer.m_drive, LEFT_4),
                        new SpinIntake()));
    }
}
